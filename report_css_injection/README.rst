...
-  **Font size css**. It can be usefull knowing that the font size
   fields of the form view injects a css similar to the following one,
   with the same attributes and selectors:
...
-  The names of the added variables (text_size, text_size_unit...) are
   too generic, and could be added by Odoo in the next versions. Check
   if this happened in the future migrations
